...
@Entity
public class PremiumCar extends MidsizeCars{

    public PremiumCar(String make, int price, String model, int year, int number_of_seats, String colour, String engine_displacement, int passenger_space) {
