...
@Entity
public class HeavyDutyTruck extends Trucks{
    public HeavyDutyTruck(String make, int price, String model, int year, int number_of_seats, String colour, String engine_displacement, int trunk_volume) {
