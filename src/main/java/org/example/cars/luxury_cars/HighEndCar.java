...
@Entity
public class HighEndCar extends LuxuryCars{
    public HighEndCar(String make, int price, String model, int year, int number_of_seats, String colour, String engine_displacement, String panorama) {
