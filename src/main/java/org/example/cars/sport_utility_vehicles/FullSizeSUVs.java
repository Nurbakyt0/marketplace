...
@Entity
public class FullSizeSUVs extends SportUtilityVehicles{
    public FullSizeSUVs(String make, int price, String model, int year, int number_of_seats, String colour, String engine_displacement, int karkas_weight) {
