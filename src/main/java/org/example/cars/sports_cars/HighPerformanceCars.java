...
@Entity
public class HighPerformanceCars extends SportCars{
    public HighPerformanceCars(String make, int price, String model, int year, int number_of_seats, String colour, String engine_displacement, String antikrylo) {
        super(make, price, model, year, number_of_seats, colour, engine_displacement, antikrylo);
    }

    public HighPerformanceCars() {
    }
