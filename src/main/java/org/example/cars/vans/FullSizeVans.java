...
@Entity
public class FullSizeVans extends Vans{
    public FullSizeVans(String make, int price, String model, int year, int number_of_seats, String colour, String engine_displacement, String captain_seat) {
