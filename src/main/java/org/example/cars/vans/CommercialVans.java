...
@Entity
public class CommercialVans extends Vans{
    public CommercialVans(String make, int price, String model, int year, int number_of_seats, String colour, String engine_displacement, String captain_seat) {
        super(make, price, model, year, number_of_seats, colour, engine_displacement, captain_seat);
    }

    public CommercialVans() {
    }
