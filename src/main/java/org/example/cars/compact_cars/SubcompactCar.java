...
@Entity
public class SubcompactCar extends CompactCars {
    public SubcompactCar(String make, int price, String model, int year, int number_of_seats, String colour, String engine_displacement, String dovodchik) {
        super(make, price, model, year, number_of_seats, colour, engine_displacement, dovodchik);
    }

    public SubcompactCar() {
    }
